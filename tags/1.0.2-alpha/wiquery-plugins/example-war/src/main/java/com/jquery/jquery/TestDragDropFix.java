 ...
 *
 */
public class TestDragDropFix extends WebPage {
	
	public static final ResourceReference JQUERY = new ResourceReference(TestDragDropFix.class, "jquery-1.4.2-fix.js");
	public static final ResourceReference JQUERY_UI_CORE = new ResourceReference(TestDragDropFix.class, "jquery.ui.core.js");	
	public static final ResourceReference JQUERY_UI_WIDGET = new ResourceReference(TestDragDropFix.class, "jquery.ui.widget.js");
	public static final ResourceReference JQUERY_UI_MOUSE = new ResourceReference(TestDragDropFix.class, "jquery.ui.mouse.js");
	public static final ResourceReference JQUERY_UI_DRAG = new ResourceReference(TestDragDropFix.class, "jquery.ui.draggable.js");
	public static final ResourceReference JQUERY_UI_DROP = new ResourceReference(TestDragDropFix.class, "jquery.ui.droppable.js");
