...
import com.wiquery.plugin.antilia.grid.ClassicNavigationTable;
 ...
 *
 */
public class TableClassicPanel extends Panel {
	 ...
	 * @param id
	 */
	public TableClassicPanel(String id) {
		super(id);
		...
		ClassicNavigationTable<Person> grid1 = new ClassicNavigationTable<Person>(
				"table1", 
				tableModel, 
