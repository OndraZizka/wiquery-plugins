 ...
 */
public class JqNextPageButton<E extends Serializable> extends JqPageableButton<E> {

	private static final long serialVersionUID = 1L;

	public JqNextPageButton(String id) {
		super(id, JQIcon.ui_icon_seek_next,new ResourceModel("NextPageButton.title"));
	}
	
	@Override
	public void onClick(AjaxRequestTarget target) {
		IPageableComponent<E> component = findPageableComponent();
		component.getNavigator().nextPage();
		/*
	...
	public boolean isEnabled() {
		IPageableComponent<E> component = findPageableComponent();
		if(component != null)
			return component.getNavigator().hasNextPage();
		return false;
	}
}
