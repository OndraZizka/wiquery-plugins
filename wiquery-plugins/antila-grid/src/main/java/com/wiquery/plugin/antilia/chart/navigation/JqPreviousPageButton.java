...
public class JqPreviousPageButton<E extends Serializable> extends JqPageableButton<E> {
	...
	public JqPreviousPageButton(String id) {
		super(id, JQIcon.ui_icon_seek_prev, new ResourceModel("PreviousPageButton.title"));
	}
	
	@Override
	public void onClick(AjaxRequestTarget target) {
		IPageableComponent<E> component = findPageableComponent();
		component.getNavigator().previousPage();
		/*
	...
	public boolean isEnabled() {
		IPageableComponent<E> component = findPageableComponent();
		if(component != null)
			return component.getNavigator().hasPreviousPage();
		return false;
	}
}
