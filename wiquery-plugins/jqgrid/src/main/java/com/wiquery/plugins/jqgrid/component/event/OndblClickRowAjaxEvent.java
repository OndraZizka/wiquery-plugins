 ...
 *
 */
public abstract class OndblClickRowAjaxEvent<B extends Serializable> extends AbstractAjaxGridAwareEvent<B> {
	 ...
	 * @param event
	 */
	public OndblClickRowAjaxEvent() {
		super(GridEvent.ondblClickRow);
	}
	 ...
	 */
	protected abstract void ondblClickRow(AjaxRequestTarget target, int row, int col, IModel<B> rowModel);
}
